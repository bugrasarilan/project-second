...
const Search = ({ setIsSearchmodal }) => {
  // setIsSearchmodal headr'ın içinden props olarak yolladım ve burada kullandım
  return (
      ...
      <OutsideClikHandler onOutsideClick={() => setIsSearchmodal(false)}>
        <div className="w-full h-full grid place-content-center relative">
          <div className="relative z-50 md:w-[600px] w-[370px]   bg-white border-2 p-10 rounded-3xl">
            {/* md:w-[600px] w-[370px] search çerçevesi 768px üstüne çıktığında 600 pxlik genişlik alıyor ama 768 altına düşerse ekren boyutu 370 px */}
